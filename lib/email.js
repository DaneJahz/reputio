...
function getWeeklyTip() {
  const tips = [
    "Respond to every Google review within 24 hours. Google's algorithm rewards businesses that engage consistently — faster responses signal an active, trustworthy business and directly improve your local search ranking.",
    "Add at least one new photo to your Google Business Profile this week. Businesses with recent photos get significantly more clicks and direction requests. Even a quick photo of your space or your work goes a long way.",
    "Make sure your business hours are accurate on Google — especially for holidays and special closures. Incorrect hours are one of the most common reasons customers leave negative reviews.",
    "Ask your happiest customers to mention specific services or your location in their review. Natural keyword mentions like 'best pizza in Jacksonville Beach' help your profile rank for those exact search terms.",
    "Post an update to your Google Business Profile this week. Regular posts signal to Google that your business is active and engaged — profiles that go 30+ days without updates start losing visibility.",
    "Check that your business name, address, and phone number are identical everywhere online — your website, Google profile, Facebook, and any directories. Even small differences hurt your local search ranking.",
    "Respond to your negative reviews first. A thoughtful, professional response to a complaint builds more trust with potential customers than ten 5-star reviews with no responses.",
    "Review velocity matters more than total count. A steady flow of new reviews every month outranks a business with 500 old reviews and nothing recent. Keep asking consistently.",
    "Your Google Business Profile description is searchable. Make sure it naturally includes your city, neighborhood, and the specific services you offer — without keyword stuffing.",
    "Thank reviewers by name and reference something specific they mentioned. Generic 'thank you for your review' responses carry no SEO value. Specific, personal responses do.",
    "Enable Google Messages on your Business Profile if you haven't already. Businesses that respond to messages rank higher and convert more profile visitors into customers.",
    "Google's AI now summarizes your reviews for potential customers. The language you use in your responses influences how your business gets described — use specific, positive keywords naturally.",
  ];
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
        ...
        <div style="background: #f9f9f9; border-radius: 8px; padding: 16px; margin: 24px 0;">
          <p style="margin: 0 0 8px; font-weight: 600; color: #111; font-size: 14px;">💡 This week's Google ranking tip</p>
          <p style="margin: 0; color: #444; font-size: 14px; line-height: 1.6;">${getWeeklyTip()}</p>
        </div>
        <p style="color: #999; font-size: 12px;">Powered by OwnerReply — AI review responses for small businesses</p>
      </div>
    `,
...
export async function sendWaitlistEmail({ email, businessName }) {
  await resend.emails.send({
    from: "Bert at OwnerReply <noreply@getownerreply.com>",
    to: email,
    subject: "You're on the OwnerReply waitlist!",
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
        <h2 style="color: #111;">You're on the list! 🎉</h2>
        <p style="color: #444; line-height: 1.6;">Hey${businessName ? ` ${businessName}` : ""}!</p>
        <p style="color: #444; line-height: 1.6;">Thanks for joining the OwnerReply waitlist. We're putting the finishing touches on the product and you'll be among the first to know when we launch.</p>
        <div style="background: #f9f9f9; border-radius: 8px; padding: 16px; margin: 24px 0;">
          <p style="margin: 0 0 8px; font-weight: 600; color: #111;">What OwnerReply does:</p>
          <p style="margin: 4px 0; color: #444; font-size: 14px;">✓ AI drafts personalized responses to every Google review</p>
          <p style="margin: 4px 0; color: #444; font-size: 14px;">✓ You approve with one click — posts directly to Google</p>
          <p style="margin: 4px 0; color: #444; font-size: 14px;">✓ 30 seconds per review — every review, every time</p>
          <p style="margin: 4px 0; color: #444; font-size: 14px;">✓ $35/mo per location — 14-day free trial included</p>
        </div>
        <p style="color: #444; line-height: 1.6;">We're a Jacksonville-based company building specifically for small business owners like you. When we launch you'll get early access and a special offer just for being on the waitlist.</p>
        <p style="color: #444; font-size: 14px;">— Bert Hagen<br>Founder, OwnerReply<br>Jacksonville, FL</p>
        <p style="color: #999; font-size: 12px; margin-top: 24px;">OwnerReply · getownerreply.com</p>
      </div>
    `,
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
        ...
        <p style="color: #444;"><strong>Email:</strong> ${email}</p>
        <p style="color: #444;"><strong>Business:</strong> ${businessName || "Not provided"}</p>
      </div>
    `,
  });
}