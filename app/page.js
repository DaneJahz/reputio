  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <main className="max-w-3xl mx-auto px-8 py-24 text-center">
        ...
        <p className="text-xl text-gray-500 mb-10 max-w-xl mx-auto">Reputio drafts professional replies to your reviews automatically. You approve with one click. Never ignore a review again.</p>
